...
def CapsNet(input_shape, n_class, num_routing):
    ...
    conv1 = layers.Conv2D(filters=256, kernel_size=24, strides=1, padding='valid', activation='relu', name='conv1')(x)

    # Layer 2: Conv2D layer with `squash` activation, then reshape to [None, num_capsule, dim_capsule]
    primarycaps = PrimaryCap(conv1, dim_capsule=64, n_channels=32, kernel_size=9, strides=2, padding='valid')
